...
<body style="background-color:   #f7f7f7 ;">
    ...
    <div class="container">
        <div class="container" id="respuesta">
            <div id="contenido-respuesta">
                <h3>Respuesta</h3>
                <br>
                <p id="text">tratamiento/tip que se le recomienda al usuario</p>
                <br>
                ...
                <br>
                <div class="container">
                    <p id="text" style="text-align: justify;">Si quieres saber mas de nosotros ingresa a nuestra pagina
                        web <a target="_blanck"
                            href="https://www.gastroquirurgica.com.co/nuestra-clinica/">https://www.gastroquirurgica.com.co/nuestra-clinica/</a>,
                        llama a una de nuestras lineas (037) 595 5775 Ext. 101 – 102, 3152732114, 3156785070 o
                        contactanos por correo electronico citas@gastroquirurgica.co
                    </p>
                </div>
                <br>
            </div>
