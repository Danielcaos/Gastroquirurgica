...
<div class="container" id="contenido">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="card mb-3">
                <img src="<?php echo constant('URL')?>public/resourse/img/si.jpg" class="card-img-top" alt="...">
                <div class="card-body">
        ...
        <div class="col-sm-6">
            <div class="card mb-3">
                <img src="<?php echo constant('URL')?>public/resourse/img/no.jpg" class="card-img-top" alt="...">
                <div class="card-body">
                    <h5 id="text" class="card-title">Tema de interes para el usuario</h5>
