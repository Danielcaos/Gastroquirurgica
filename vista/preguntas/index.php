    ...
    <div class="container" id="contenido">
        ...
        <div class="container" id="politicas">
            <div class="input-group mb-3">
                ...
                <input type="email" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="example@example.ex" id="email">
            </div>
            <div class="form-check">
                <input class="form-check-input" type="checkbox" value="" id="checkbox1">
                <label class="form-check-label" for="flexCheckDefault">
                    <p id="text">Al continuar aceptas los terminos de la <a style="font-weight: bold;" target="_blanck" href="https://www.gastroquirurgica.com.co/politica-de-tratamiento-de-datos-personales/">POLÍTICA
                            DE PRIVACIDAD EN EL
            ...
            <div class="form-check">
                ...
                <label class="form-check-label" for="flexCheckDefault">
                    <p id="text">Me gustaria recibir actualizaciones sobre los servicios de la Clinica
