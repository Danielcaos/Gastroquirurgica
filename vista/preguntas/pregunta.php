        ...
        <div class="container">
            <div class="container" id="preguntas">
                <div id="contenido-pregunta">
                    ...
                    <br>
                    <div class="row">
                        <div class="col-sm-4"><img id="doctor" src="<?php echo constant('URL') ?>public/resourse/img/doctor.png" class="img-fluid" alt="..."></div>
                        <div class="col-sm-8">
                    ...
                    <div class="input-group mb-3" style="padding-top: 17px;">
                        <input id="edad" type="number" class="form-control" placeholder="Edad" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <input id="estatura" type="number" class="form-control" placeholder="Estatura (m)" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
                        <input id="peso" type="number" class="form-control" placeholder="Peso (kg)" aria-label="Username" aria-describedby="basic-addon1">
                    </div>
